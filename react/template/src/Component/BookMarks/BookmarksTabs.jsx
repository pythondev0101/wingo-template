    ...
    <Fragment>
      <TabContent activeTab={activeTabss}>
        ...
        <TabPane tabId="2">
          <Card className="mb-0">
            <CardHeader className="d-flex">
              <H5 attrH6={{ className: 'mb-0' }}>{Favourites}</H5>
              <ViewBookmark />
            </CardHeader>
            <CardBody>
              <div className={`details-bookmark text-center ${gridView ? '' : 'list-bookmark'}`}>
        ...
        <TabPane tabId="4">
          <Card className="mb-0">
            <CardHeader className="d-flex">
              <H5 attrH6={{ className: 'mb-0' }}>{MyBookmark}</H5>
              <ViewBookmark />
            </CardHeader>
            <CardBody>
              <div className={`details-bookmark text-center ${gridView ? '' : 'list-bookmark'}`} >
        ...
        <TabPane tabId="5">
          <Card className="mb-0">
            <CardHeader className="d-flex">
              <H5 attrH6={{ className: 'mb-0' }}>{Notification}</H5>
              <ViewBookmark />
            </CardHeader>
            <CardBody>
        ...
        <TabPane tabId="6">
          <Card className="mb-0">
            <CardHeader className="d-flex">
              <H5 attrH6={{ className: 'mb-0' }}>{Newsletter}</H5>
              <ViewBookmark />
            </CardHeader>
            <CardBody>
              <div className="details-bookmark text-center">
