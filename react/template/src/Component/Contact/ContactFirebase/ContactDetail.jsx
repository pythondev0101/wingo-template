        ...
        <div className="profile-mail">
          ...
          <div className="email-general">
            ...
            <UL attrUL={{ className: 'simple-list' }}>
              ...
              <LI>{Age} 
                <span className="font-primary">{selectedUser.age}</span></LI>
              <LI>{MobileNo} 
                <span className="font-primary mobile_num_0">{selectedUser.mobile}</span></LI>
              <LI>{EmailAddress} 
                <span className="font-primary email_add_0">{`${selectedUser.name}@gmail.com`} </span></LI>
            </UL>
          </div>
        </div>
        :
