        ...
        <Card>
          <CardBody>
            ...
            <div className="pro-group">
              <P>{productss.discription}The point of using Lorem Ipsum is that.</P></div><div className="pro-group">
              <Row>
                <Col md="6">
                  <Table>
                    <tbody>
            ...
            <div className="pro-group pb-0">
              <div className="pro-shop">
                <Link to={`${process.env.PUBLIC_URL}/ecommerce/cart`}>
                  <Btn attrBtn={{ color: 'primary', className: 'btn btn-primary mt-1' }}>
                    <i className="fa fa-shopping-basket me-2"></i>{AddToCart}</Btn></Link>
                <Btn attrBtn={{ color: 'secondary', className: 'btn btn-warning mt-1', onClick: () => addWishList(singleItem) }}>
