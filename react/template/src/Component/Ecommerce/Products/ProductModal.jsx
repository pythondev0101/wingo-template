...
import ModelIcon from './ModalIcons';
            ...
            <Col lg="6" className="product-details text-start">
              ...
              <div className="product-qnty">
                ...
                <div className="addcart-btn">
                  <Link to={`${process.env.PUBLIC_URL}/ecommerce/cart`} className="btn btn-primary " onClick={() => AddToCarts(singleProduct, quantity)}>{AddToCart}</Link>
                  <Link
