    ...
    <Fragment>
      <Col lg="12" >
        ...
        <Row className="row default-according style-1 faq-accordion" id="accordionoc">
          <Col xl="8" lg="6" md="7" className='box-col-7 faq-accor xl-60' >
            {faq && faq.map((item, i) => {
              return (
                <Fragment key={i} >
                        ...
                        <Card key={item.id}>
                          <CardHeader>
                            <H5 attrH5={{ className: 'mb-0' }}>
                              <Btn attrBtn={{ color: 'link', onClick: () => handelChange(item.id), datatoggle: 'collapse', datatarget: '#collapseicon14', ariaexpanded: 'true', ariacontrols: 'collapseicon14' }}><HelpCircle />{item.title}</Btn>
                            </H5>
                          </CardHeader>
