...
const FileSideBar = () => {
  ...
  return (
    <Fragment>
      <Col xl="3" className="box-col-4 file-spacing xl-30">
        <div className="md-sidebar job-sidebar">
          <a className="btn btn-primary md-sidebar-toggle" href="#javascript" onClick={onClickHandle}>File filter</a>
