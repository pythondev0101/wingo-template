  ...
  return (
    <Fragment>
      <Form className="form theme-form base-input">
          ...
          <Row>
            <Col>
              ...
              <Row className="mb-3">
                ...
                <Col sm="9">
                  <Input className="form-control" id="example-datetime-local-input" type="datetime-local" defaultValue="2022-01-19T18:45:00" />
                </Col>
              </Row>
              <Row className="mb-3">
                <Label className="col-sm-3 col-form-label">{Date}</Label>
                <Col sm="9">
                  <Input className="form-control" type="date" defaultValue="2022-01-01" />
                </Col>
              </Row>
              <Row className="mb-3">
                <Label className="col-sm-3 col-form-label">{Month}</Label>
                <Col sm="9">
                  <Input className="form-control" type="month" defaultValue="2022-01" />
                </Col>
              </Row>
              <Row className="mb-3">
                <Label className="col-sm-3 col-form-label">{Week}</Label>
                <Col sm="9">
                  <Input className="form-control" type="week" defaultValue="2022-W09" />
                </Col>
              </Row>
              <Row className='mb-3'>
        ...
        <CardFooter className='pt-0'> <Col sm="9">
