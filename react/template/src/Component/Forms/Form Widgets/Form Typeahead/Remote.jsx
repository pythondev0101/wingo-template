      ...
      <Form className="theme-form">
        <FormGroup>
          ...
          <ButtonToolbar style={{ marginTop: '10px', margin: '4px' }}>
            <Btn attrBtn={{ className: 'm-2', color: 'primary', onClick: () => ref.current.clear() }}>
              {'Clear'}
            </Btn>
            <Btn attrBtn={{ className: 'm-2', color: 'primary', onClick: () => ref.current.focus() }}>
              {'Focus'}
            </Btn>
            <Btn attrBtn={{
              className: 'm-2', color: 'primary', onClick: () => {
                ref.current.focus(); setTimeout(() => ref.current.blur(), 1000);
              }
            }}>
