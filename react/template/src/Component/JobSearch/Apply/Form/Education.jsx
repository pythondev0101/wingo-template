      ...
      <Form className="theme-form">
        <Row>
          <Col xl="6" className='xl-100'>
            <FormGroup>
              <Label htmlFor="exampleFormControlInput5">{CollegeName}:
          ...
          <Col xl="6" className='xl-100'>
            <Label className="col-form-label text-end pt-0">{Period}:
              <span className="font-danger">*</span>
            </Label>
            <Row>
              <Col sm="6">
              ...
              <Col sm="6">
                <FormGroup>
                  <DatePicker className="form-control" selected={startDate1} onChange={handleChange1} />
                </FormGroup>
              </Col>
            </Row>
          </Col>
          <Col lg="6">
            <div className="col-form-label pt-0">{DegreeLevel}:
              <span className="font-danger">*</span>
            </div>
            <FormGroup>
              <Typeahead
          ...
          <Col lg="6">
            <FormGroup>
              <div className='col-form-label pt-0'>{Specialization}:
                <span className="font-danger">*</span>
              </div>
              <Input className="form-control" type="email" placeholder="Enter specialization" />
            </FormGroup>
          </Col>
        </Row>
      </Form>
