      ...
      <Form className="theme-form">
        <Row>
          <Col xl="6" className='xl-100'>
            <FormGroup>
              <Label htmlFor="exampleFormControlInput7">{Location}:
          ...
          <Col xl="6" className='xl-100'>
            <div className="col-form-label pt-0">{Position}:
              <span className="font-danger">*</span>
            </div>
            <FormGroup>
              <Typeahead
          ...
          <Col xl="6" className='xl-100'>
            <FormGroup>
              <div className='col-form-label pt-0'>{CompanyName}:
                <span className="font-danger">*</span>
              </div>
              <Input className="form-control" type="email" placeholder="Enter Company Name" />
            </FormGroup>
          </Col>
        </Row>
      </Form>
