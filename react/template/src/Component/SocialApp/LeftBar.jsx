...
import { Btn, H5, H4, H6, LI, UL, Image } from '../../AbstractElements';
        ...
        <Card>
          <CardHeader>
            <H5 attrH5={{ className: 'mb-0' }}>
              <Btn attrBtn={{ color: 'link ps-0', onClick: () => setisProfile(!isProfile), databstoggle: 'collapse', datatarget: '#collapseicon5', ariaexpanded: 'isProfile', ariacontrols: 'collapseicon5' }} >{MyProfile}</Btn> </H5>
          </CardHeader>
                  ...
                  <span className="d-block">
                    <span>
                      ...
                      <span className="px-2">{Messages}
                        <span className="badge rounded-pill badge-light ms-1">{'9'}</span></span>
                    </span>
                  </span>
                  <span className="d-block"><span><i className="fa fa-bell-o"></i><span className="px-2">{Notification}<span className="badge rounded-pill badge-light ms-1">{'9'}</span></span></span></span>
                </Media>
              </Media>
