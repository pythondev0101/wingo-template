...
const TableBackgroundClass = () => {
  ...
  return (
    <Col sm="12">
      <Card>
        <CardHeader>
          <H5>{TableHeadOptionsPrimaryBackground}</H5>
          <span>{'Use background classes'}
            <code>{'.bg-*'}</code>{'and'} 
            ...
            <code>{'table-warning'}</code>  {'to make custom'} 
            <code>{'thead'}</code> {'background. You can also use Stack Admin color palette classes for background.'}
          </span>
        </CardHeader>
