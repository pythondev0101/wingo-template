    ...
    <Fragment>
      <Col xl="3" className="box-col-4 xl-30">
        <div className="md-sidebar">
          <a className="btn btn-primary md-sidebar-toggle" href="#javascript" onClick={onClickSidebar}>Task Filter</a>
                  ...
                  <Nav className="main-menu" role="tablist">
                    ...
                    {tagData.map((item) =>
                      <Fragment key={item.id}>
                        <NavItem>
                          <a href="#javaScript" className={activeTab === item.activeTab ? 'show' : ''} onClick={() => {
                            setActiveTab(item.activeTab); activeToggle(item.activeTab);
                          }} >
                            <span className="title"> {item.title}</span>
                          </a>
