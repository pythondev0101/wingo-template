...
import { AboutMe, Dribbble, Facebooks, SocialNetworks, Twitters } from '../../../Constant';
          ...
          <Collapse isOpen={aboutme}>
            <CardBody className="post-about">
              ...
              <div className="social-network theme-form">
                ...
                <Btn attrBtn={{ className: 'btn social-btn mb-2 text-center', color: 'fb' }}>
                  <i className="fa fa-facebook m-r-5"></i>{Facebooks}
                </Btn >
                <Btn attrBtn={{ className: 'btn social-btn mb-2 text-center', color: 'twitter' }} >
                  <i className="fa fa-twitter m-r-5"></i>{Twitters}
                </Btn>
                <Btn attrBtn={{ className: 'btn social-btn text-center', color: 'google' }} >
