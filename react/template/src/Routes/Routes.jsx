...
export const routes = [
    ...
    { path: `${process.env.PUBLIC_URL}/buttons/default-style`, Component: <DefaultStyle /> },
    { path: `${process.env.PUBLIC_URL}/buttons/flat-style`, Component: <FlatStyle /> },
    { path: `${process.env.PUBLIC_URL}/buttons/edge-style`, Component: <EdgeStyle /> },
    { path: `${process.env.PUBLIC_URL}/buttons/raised-style`, Component: <RaisedStyle /> },
    { path: `${process.env.PUBLIC_URL}/buttons/button-group`, Component: <AllButtonGroup /> },
