...
import { AllCloseAccordion, CollapsibleGroupItem } from '../../../../Constant/index';
            ...
            <div className="default-according" id="accordion1">
                ...
                <CardHeader className="bg-primary">
                  <H5 attrH5={{ className: 'mb-0' }} >
                    <Btn attrBtn={{ as: Card.Header, className: 'btn btn-link', color: 'default', onClick: () => toggle(1) }} >
                      <i className="icofont icofont-briefcase-alt-2"></i>{CollapsibleGroupItem}<span>1</span>
                    </Btn>
                  </H5>
                </CardHeader>
              ...
              {data.map((accordian, i) =>
                <Card key={i}>
                  <CardHeader className="bg-primary">
                    <H5 attrH5={{ className: 'mb-0' }} >
                      <Btn attrBtn={{ as: Card.Header, className: 'btn btn-link', color: 'default', onClick: () => toggle(accordian.id) }} >
                        <i className={`icofont ${accordian.icon}`}></i>{CollapsibleGroupItem}<span>{accordian.id}</span>
                      </Btn>
                    </H5>
                  </CardHeader>
